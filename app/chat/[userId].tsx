...
type TipoMensaje = 'texto' | 'imagen' | 'gif' | 'invitacion_timba' | 'invitacion_poker' | 'invitacion_truco' | 'invitacion_blackjack' | 'invitacion_pool'
        ...
        <View style={{ flex: 1, alignItems: mio ? 'flex-end' : 'flex-start' }}>
          <TouchableOpacity
            ...
            style={[
              ...
              miBurbuja,
              (m.tipo === 'invitacion_timba' || m.tipo === 'invitacion_poker' || m.tipo === 'invitacion_truco' || m.tipo === 'invitacion_blackjack' || m.tipo === 'invitacion_pool') && { padding: 10 },
            ]}
          >
            {m.tipo === 'texto' && (
            ...
            {m.tipo === 'invitacion_pool' && (() => {
              ...
              return (
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, width: 240 }}>
                  <AppIcon name="pool" size={26} color={mio ? c.fondoCard : c.primario} />
                  <View style={{ flex: 1 }}>
                    <Text style={{ color: mio ? c.fondo : c.texto, fontWeight: '800', fontSize: 14 }}>
                      Pool · 8-Ball
                    </Text>
